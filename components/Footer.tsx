        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12 border-b border-[var(--border)]">
          ...
          <div>
            ...
            <div className="flex gap-3">
              {["fb", "ig", "tw", "li"].map((s) => (
                <div key={s} className="w-9 h-9 rounded-full bg-[var(--surface-2)] border border-[var(--border)] flex items-center justify-center text-[var(--muted)] hover:bg-[#4A6CF7] hover:border-[#4A6CF7] hover:text-white transition-all cursor-pointer font-heading font-bold text-xs">
                  {s}
                </div>
              ))}
            </div>
