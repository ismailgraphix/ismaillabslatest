        ...
        <aside className={`h-screen sticky top-0 flex flex-col bg-[#0d0d0d] border-r border-white/[0.06] transition-all duration-300 flex-shrink-0 ${collapsed ? "w-[56px]" : "w-[220px]"}`}>
                    ...
                    {visibleNav.map(item => {
                        ...
                        return (
                            <Link key={item.href} href={item.href}
                                  className={`relative flex items-center gap-2.5 px-3 py-2.5 text-sm transition-all duration-150 group rounded-sm ${
                                      active ? "bg-[#4353FF] text-white" : "text-gray-400 hover:text-white hover:bg-white/5"
                                  }`}>
                                    ...
                                    <>
                                        ...
                                        {item.badge && unreadCount > 0 && (
                                            <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full leading-none ${
                                                active ? "bg-white text-[#4353FF]" : "bg-[#4353FF] text-white"
            ...
            {!collapsed && (
                <div className="px-4 py-2 border-t border-white/[0.04]">
                    <div className={`inline-flex items-center gap-1.5 px-2.5 py-1 text-[10px] font-body font-bold uppercase tracking-wider ${
                        superAdmin ? "text-yellow-400 bg-yellow-400/10" : "text-[#4353FF] bg-[#4353FF]/10"
                    }`}>
                    ...
                    {!collapsed && (
                        <>
                            <div className="flex-1 min-w-0">
                                <p className="font-heading font-bold text-white text-xs truncate leading-none">{userName}</p>
