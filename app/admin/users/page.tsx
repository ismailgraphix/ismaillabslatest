                            ...
                            ● {u.status}
                                            ...
                                            <td className="px-5 py-4">
                                                <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                                                    {/* Permissions — only for non-super, only by super_admin */}
                                                    ...
                                                    {/* Edit — super_admin edits everyone except other super_admins */}
                                                    {!isSuper && isSuperAdmin && (
                                                    ...
                                                    {!isSuper && isSuperAdmin && !isSelf && (
                                                        <button onClick={() => toggleStatus(u)}
                                                                className={`font-body text-xs px-2.5 py-1 border transition-all ${
                                                                    u.status === "active"
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    {ROLES.map(role => (
                                        <label key={role} className={`flex items-start gap-3 p-3 border cursor-pointer transition-all ${
                                            form.role === role ? "border-[#4353FF] bg-[#4353FF]/5" : "border-white/[0.06] hover:border-white/15"
                                        }`}>
                                            ...
                                            <div>
                                                ...
                                                <p className="font-body text-gray-700 text-[10px] mt-1">
                                ...
                                return (
                                    <div key={mod}>
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            {allGranted && (
                                                <span className="font-body text-[10px] text-green-400 bg-green-400/10 px-2 py-0.5 border border-green-400/20">
                          Full access
                        </span>
                                            )}
                                        </div>
                                                ...
                                                return (
                                                    <label key={perm.name}
                                                        ...
                                                        <div className="min-w-0">
                                                            <p className={`font-body text-xs font-medium truncate ${isGranted ? "text-white" : "text-gray-500"}`}>
                                                                {perm.label}
                                                            </p>
                                                            <p className="font-body text-[10px] text-gray-700 truncate">{perm.name}</p>
                                                        </div>
                                                        {isDefault && (
                                                            <span className="font-body text-[9px] text-gray-600 ml-auto flex-shrink-0">default</span>
                                                        )}
                                                        {isExtra && (
                                                            <span className="font-body text-[9px] text-[#4353FF] ml-auto flex-shrink-0">granted</span>
                                                        )}
                                                    </label>
                                                );
                                            })}
